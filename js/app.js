...
(function ($) {
	...
	"use strict";
	const scrollCorrection = 80; // (header height = 50px) + (gap = 20px)
	...
	function setScrollReveal() {
		...
		const sr = ScrollReveal({
			...
			beforeReveal: function (ele) {
				// ele.style["-webkit-filter"] = "blur(3px)";
				// ele.style.filter = "blur(3px)"
				// ele.style.filter = "progid:DXImageTransform.Microsoft.Blur(PixelRadius='3')";
				setTimeout(function(){
			...
			afterReveal: function (domEl) {
				domEl.style.transform = domEl.style["-webkit-transform"] = "";
				// ele.style["-webkit-filter"] = "blur(0px)";
				// ele.style.filter = "blur(0px)";
				
				// ele.style.filter = "progid:DXImageTransform.Microsoft.Blur(PixelRadius='0')";
			}
		});
		sr.reveal('.reveal');
	}
